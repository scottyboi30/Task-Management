...
var StateService = /** @class */ (function () {
    ...
    StateService.prototype.getStateOptions = function () {
        var states = [];
        for (var value in _shared_enums_state__WEBPACK_IMPORTED_MODULE_2__["State"]) {
    ...
    StateService.prototype.getAllStatesBit = function () {
...
var StateStringPipe = /** @class */ (function () {
    function StateStringPipe() {
    }
    StateStringPipe.prototype.transform = function (state) {
...
var TaskFormComponent = /** @class */ (function () {
    function TaskFormComponent(formBuilder, service, router, route, stateService) {
    ...
    TaskFormComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.route.params.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["switchMap"])(function (_a) {
            var id = _a.id;
            if (id) {
                return _this.service.getTask(id);
            }
            return Object(rxjs__WEBPACK_IMPORTED_MODULE_7__["of"])({ title: '', description: '', state: 1 });
        }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["takeUntil"])(this.destroyed$)).subscribe(function (task) {
            _this.task = task;
            _this.setUpForm();
        });
    };
    TaskFormComponent.prototype.saveTask = function () {
        ...
        if (this.taskForm.invalid)
            return;
        this.service.saveTask(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({ id: this.task.id }, this.taskForm.value))
            .subscribe(function () { return _this.router.navigateByUrl('/tasks'); });
    };
    TaskFormComponent.prototype.setUpForm = function () {
...
var TasksComponent = /** @class */ (function () {
    function TasksComponent(service, stateService) {
        this.service = service;
        this.stateService = stateService;
        this.stateOptions = [];
    }
    TasksComponent.prototype.ngOnInit = function () {
        ...
        this.service.getTasksByState(this.stateFilter).subscribe(function (tasks) { return _this.tasks = tasks; });
    };
...
var TasksService = /** @class */ (function () {
    ...
    TasksService.prototype.saveTask = function (task) {
        var taskId = !task.id ? guid_typescript__WEBPACK_IMPORTED_MODULE_3__["Guid"].create().toString() : task.id;
        return this.http.put(_environments_environment__WEBPACK_IMPORTED_MODULE_5__["environment"].baseUrl + "/" + taskId, task)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["take"])(1));
    };
    ;
    TasksService.prototype.getTasksByState = function (stateFilter) {
